...
public:
  ...
  void controlLoop(const ros::TimerEvent& t){
    ...
    msg.angular_velocities[2] = 5; // Amplitude change of all legs
    msg.angular_velocities[3] = 2; // Amplitude change of back legs (added to angular_velocities[2])
    msg.angular_velocities[4] = 0.5; // Frequency of legs
