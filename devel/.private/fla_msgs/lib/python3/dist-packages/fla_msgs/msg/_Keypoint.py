...
"""autogenerated by genpy from fla_msgs/Keypoint.msg. Do not edit."""
import codecs
import sys
...
class Keypoint(genpy.Message):
  _md5sum = "b8a73f27507e9626faa0d25bacb6ecf2"
  _type = "fla_msgs/Keypoint"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# (x, y) define the keypoint location in pixel coordinates
uint32 id
float32 x 
float32 y
"""
