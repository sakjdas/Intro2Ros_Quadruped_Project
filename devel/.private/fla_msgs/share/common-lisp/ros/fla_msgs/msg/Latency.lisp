...
(cl:defmethod cl:initialize-instance :after ((m <Latency>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Latency)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fla_msgs-msg:<Latency> is deprecated: use fla_msgs-msg:Latency instead.")))
...
(cl:defmethod latency-val ((m <Latency>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fla_msgs-msg:latency-val is deprecated.  Use fla_msgs-msg:latency instead.")
  (latency m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Latency>)))
  ...
  "7d52a49060461c16e2604d5e22a14f13")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Latency)))
  "Returns md5sum for a message object of type 'Latency"
  "7d52a49060461c16e2604d5e22a14f13")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Latency>)))
  ...
  (cl:format cl:nil "Header header~%float64 latency~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Latency)))
  "Returns full string definition for message of type 'Latency"
  (cl:format cl:nil "Header header~%float64 latency~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
